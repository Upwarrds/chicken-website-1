...
export default function Header(params) {
    ...
    return(
        <>
<nav className="bg-[#fff] sticky top-0 z-20 border-b-2 border-[#fff] shadow-sm">
			<div className="container px-4 mx-auto flex justify-between items-center h-16 my-4">
				{/* Logo Section */}
				...
				<div className="sm:hidden">
					<button
						...
						className="text-[#353535] rounded-[2px] focus:outline-none"
					>
						<svg
							className="w-6 h-6"
							fill="none"
